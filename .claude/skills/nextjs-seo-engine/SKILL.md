...
- `sitemap.ts` streams from the DB: all `active`+`sold` items, categories, brands, qualifying category×city pages, static pages. Split at 45,000 URLs into a sitemap index — the hard limit is 50,000 and programmatic pages grow fast.
